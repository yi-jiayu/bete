...
func (r PostgresFavouriteRepository) Find(userID int, text string) string {
	var query string
...
func (r PostgresFavouriteRepository) Put(userID int, name, query string) error {
...
func (r PostgresFavouriteRepository) List(userID int) ([]string, error) {
